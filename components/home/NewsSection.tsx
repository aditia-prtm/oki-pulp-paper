        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {articles.map((news, idx) => (
            <motion.article
              ...
              className="group flex flex-col bg-white rounded-2xl overflow-hidden border border-neutral-200/80 shadow-sm hover:shadow-xl hover:border-neutral-300 transition-all duration-300"
            >
              <Link href={news.href || "#news"} className="flex flex-col flex-1">
                <div className="relative aspect-[16/10] overflow-hidden bg-neutral-100">
                  ...
                  <div className="absolute top-3 left-3">
                    <span className="px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider bg-white/95 text-[#D91A2A] rounded-md shadow-sm backdrop-blur-sm">
                      {news.category}
                    </span>
                  </div>
                </div>
